<div>
  <h1 align="center"><a href="https://go.mikecodeur.com/react-mastery">TypeScript DOM 🚀 </a></h1>
  <strong>
    Module sur la manipulation du DOM avec TypeScript 
  </strong>
  <p>
...
```
git clone https://github.com/MikeCodeur/typescript-dom.git
cd typescript-dom
npm run init
```
...
[déploiement sur Netlify](https://typescript-dom.mikecodeur.com//).
...
<table>
  <tr>
    <td align="center"><a href="https://mikecodeur.com"><img src="https://avatars.githubusercontent.com/u/595162?v=4?s=100" width="100px;" alt=""/><br /><sub><b>Mike Codeur</b></sub></a><br /><a href="https://github.com/mikecodeur/typescript-dom/commits?author=mikecodeur" title="Code">💻</a> <a href="https://github.com/mikecodeur/typescript-dom/commits?author=mikecodeur" title="Documentation">📖</a> <a href="#infra-mikecodeur" title="Infrastructure (Hosting, Build-Tools, etc)">🚇</a> <a href="https://github.com/mikecodeur/typescript-dom/commits?author=mikecodeur" title="Tests">⚠️</a></td>
  </tr>
...
[build-badge]: https://img.shields.io/github/workflow/status/MikeCodeur/typescript-dom/installation
[build]: https://github.com/MikeCodeur/typescript-dom/actions
...
[license]: https://github.com/mikecodeur/typescript-dom/blob/main/LICENSE
[all-contributors]: https://github.com/mikecodeur/all-contributors
[all-contributors-badge]: https://img.shields.io/github/all-contributors/mikecodeur/typescript-dom?color=orange&style=flat-square
...
[issue]: https://github.com/mikecodeur/typescript-dom/issues/new
<!-- prettier-ignore-end -->
